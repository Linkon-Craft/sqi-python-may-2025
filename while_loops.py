...
# Question: Write a while loop to calculate the sum of numbers from 1 to 10.
# sum = 0
# i = 1
# while i <= 10:
#     sum += i
...
# Question: Create a simple game where the program picks a number (e.g., 7) and asks the user to guess it. Use a while loop to keep 
# asking until the user guesses correctly.
import random
...
#     if guess < secret_num:
#         print(f"You guess too low. You have {attempts} left")
#     elif guess > secret_num:
#         print(f"You guess too high. You have {attempts} left")  
# else:
#     print(f"Your secret number is {secret_num}")
...
# 7. Write a program that takes two integers, base and exponent, from the user and uses a while loop to calculate base
...
# 4. Keep asking for input until the user types "exit"

# string = input("Enter (exit): ").strip()
# while True:
#     if string != "exit":
#         string = input("Enter (exit): ").strip()
#         continue
...
# while True:
#     if num == secret_num:
#         print(f"Congratulation you are correct. The secret number is {num}")
#         break
#     elif num >= secret_num:
#         attempt -= 1
#         print(f"incorrect numer. You have {attempt} attempt left")
#         num = int(input("Enter the secret number: "))
#         continue
#     elif num <= secret_num:
#         attempt -= 1
#         print(f"Incorrect number, number is below secret number. You have {attempt} attempt left")
#         num = int(input("Enter the secret number: "))
#         continue
#     elif num > range(secret_num):
#         attempt -= 1
#         print(f"Number Out of range. You have {attempt} attempt left")
#         num = int(input("Enter the secret number: "))
#         continue
#     elif num < range(secret_num):
#         attempt -= 1
...
# while multiply <= 20:
#     result = n * multiply
#     print(f"{n} X {multiply} = {result}")
#     multiply += 1


# 8. Reverse a number

# number = int(input("Enter numbers to reverse: "))
# num = []
# while number >= 1:
...
# digit = int(input("Enter some digit: "))
# n = abs(digit)
# count = 0
# if n == 0:
#     count += 1
...
# number = int(input("Enter some digit: "))
# num = abs(number)
# total = 0
# while num > 0:
#     digit = num % 10
...
# 1. Count Even and Odd Digits in a Number
...
#         odd_number += 1
#     num //= 10
# print(f"even count: {even_number}, odd count: {odd_number} of {num}")
