...
# science_club = {"John", "Mia", "Liam", "Olivia"}
# music_club = {"Emma", "Liam", "Noah", "Olivia"}
# print(science_club.intersection(music_club))
...
# animals_2 = ("horse", "Sheep")
# animals.update(animals_2)
# print(animals)
...
# 6. Given the list seasons = ["Spring", "Summer", "Fall", "Winter", “Spring”], convert the list to a set to get rid of 
# the duplicate `Spring`.
...
setA = {"a", "b", "c"} 
setB = {"c", "d", "e"}
over_set = setA.intersection(setB)
print(over_set)
...
letters = {"a", "b", "c"}
other_letters = {"b", "c", "d"}
diff_letters = letters.symmetric_difference(other_letters)
print(diff_letters)
