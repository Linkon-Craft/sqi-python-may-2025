...
#3. Create a dictionary called `employee` with keys "name" and "position", and corresponding values "Alice" and 
# "Manager". Add a new key "salary" with the value 50000.
employee = {"name": "Alice", "postion": "Manager"}
employee["salary"] = 50000
print(employee)

# 4. Create a dictionary called `inventory` with keys "apple", "banana", and "orange", and values 10, 5,
# and 8 respectively. Remove the key "banana".

inventory = {"apple": 10, "banana": 5, "orange": 8}
del inventory["banana"]
print(inventory)

# 5. Create a dictionary called person with keys "name", "age", and "city", and corresponding values "Bob", 25, 
# and "New York". Use the copy() method to make a copy of the dictionary and call it person_copy.
...
# 6. Create a nested dictionary called `family` with keys "child1", "child2", and "child3", each containing a dictionary 
# with keys "name" and "age" with appropriate values. Access and print the age of "child2".

family = { 
          "child1": {"name": "Lekan", "age": 26}, 
          "child2": {"name": "Lovren", "age": 22}, 
          "child3": {"name": "christian", "age": 30},
}
print(family["child2"]["age"])

# 7. Create a dictionary called `car` with keys "brand", "model", and "year", and corresponding values "Toyota", "Corolla", 
# and 2020. Access and print the value of "model".
car = {"brand": "Toyota", "model": "Corolla", "year": "2020"}
print(car["model"])

# 8. Create a dictionary called `settings` with keys "volume", "brightness", and "language", and corresponding values 50, 75, 
# and "English". Change the "language" to "Spanish".
...
menu = {"starter": "Soup", "main_course": "Steak", "main_course": "Ice Cream"}
print("Appetizer" in menu)

# 11. Create a dictionary called `config` with keys "theme", "language", and "timezone", and corresponding values "dark",
#  "English", and "UTC". Clear the dictionary.

# config = {"theme": "dark", "language": "English", "timezone": "UTC"}
# del config
# print(config)

# 12.Create a dictionary called `phone_book` with keys "Alice", "Bob", and "Charlie", and corresponding phone numbers as values.
#  Print the number of items in the dictionary.

phone_book = {"Alice": "08044732917", "Bob": "09167899021", "charlie": "07042563412"}
print(len(phone_book))

# 13.  Create a dictionary called `grades` with keys "math", "science", and "history", 
# and corresponding values "A", "B", and "C". Get a LIST of all the keys in the dictionary.
...
employee = {"name": "David", "position": "Engineer", "Salary": 7000}
print(list(employee.values()))

# 15. Create a dictionary called `game` with keys "title", "genre", and "rating", and corresponding values "Minecraft", "Sandbox", 
# and 4.5. Get a LIST of all key-value pairs in the dictionary.
