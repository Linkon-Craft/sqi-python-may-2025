...
# print(age)
# print(age_and_position)
# print(first_dept)
# print(second_dept, first_dept)
...
# Exercises
# Exercise 1
# Define a 3×3 tuple grid of numbers (like a calculator keypad). Ask the user for a row and column (0-indexed) 
# and print the value at that position. Then ask for a second position and return the sum of the two numbers.
...
# 3. Create a tuple called person with values ("John", 25, "Engineer"). Unpack the values 
# into variables name, age, and profession, and print the value of profession.
...
# record = ("Jane", (32, "Manager"), ["HR", "Finance"])
# name, (age, position), [first_dept, second_dept] = record
# print(age, first_dept)

# 7. Create a tuple called triplet with values ("one", "two", "three"). Unpack the tuple into variables and
